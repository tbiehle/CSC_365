...
General Conventions.
 ...
 3. All string values are enclosed in single quotes (')
  ...
  The dataset consists of the following files:
     ...
     - appellations.csv  : list of appellations/American Viticultural Areas (AVAs)
...
appelations.csv
   ...
   Appellation: name of the appellation/AVA/grape-growing region
...
Notes: "Appellation" is a general term for geographic grape origins in a wine.
...
Appellation: origin of the grapes (see appellations.Appellation)
